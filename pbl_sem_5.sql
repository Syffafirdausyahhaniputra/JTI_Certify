...
--
-- Host: localhost:3306
-- Generation Time: Dec 13, 2024 at 12:52 AM
...
(1, 3, NULL, NULL, NULL, '2024-11-10 13:55:38', '2024-11-10 13:55:38'),
...
(68, 2, NULL, 4, 4, NULL, '2024-12-12 16:01:19');
...
(8, 4, 2, NULL, NULL),
(9, 4, 1, NULL, NULL),
(10, 68, 1, '2024-12-12 16:01:19', '2024-12-12 16:01:19');
...
(8, 4, 1, NULL, NULL),
(9, 4, 2, NULL, NULL),
(10, 68, 2, '2024-12-12 16:01:19', '2024-12-12 16:01:19');
...
(1, 1, 'admin1', 'administrator', '1234567891', '1732992479WhatsAppImage2023-11-07at18.51.53_2102badf.jpg', '$2y$12$xpMk6Iroffl7klOxNPflEuX1rlQOAVISLVk5iq7EFkwhh/hNS1s0q', 'administrator@gmail.com', '2024-11-07 23:22:21', '2024-12-08 05:48:35'),
(2, 2, 'lead01', 'Syffa Firdausyah', '1234567899', '1733796354a1.jpg', '$2y$12$jbSg3KiNxOyL1/ceO9VUvu1iwsE3lQKxkKXRc./q0ysxxNqHIXETu', 'syffafirdausyah@gmail.com', '2024-11-08 00:50:53', '2024-12-09 19:05:54'),
(3, 3, 'dosen01', 'Muhammad Taufiq Abdus Salam', '0303030303', '1733199508dosen01.jpg', '$2y$12$PZD3kr8MnveiujhhR9JnIuiqaKQJic5qpfa6DoVHiYdNv7G0BmYH.', NULL, '2024-11-10 06:53:35', '2024-12-02 21:18:28'),
...
(1, 1, 1, NULL, NULL, '2024-11-10 15:10:10', '2024-11-10 15:10:10'),
(2, 1, 2, NULL, NULL, '2024-11-10 15:10:10', '2024-11-10 15:10:10'),
...
(1, 1, 1, NULL, NULL, '2024-11-10 14:09:07', '2024-11-10 14:09:07'),
(2, 2, 2, NULL, NULL, '2024-11-10 14:09:07', '2024-11-10 14:09:07');
...
(1, 1, 1, 2, 1, 'Pelatihan Pengembangan Web', '10000000', '2024-11-14', NULL, '10', 'Jakarta', '2024', 'Proses', 'Menunggu Validasi', '2024-11-10 14:01:54', '2024-12-12 14:55:18'),
...
(1, 1, 1, 2, 1, 'Pengembangan web', '20000000', '2024-11-14', NULL, '2025-11-14', '2024', 'Selesai', 'Selesai', '2024-11-10 13:58:10', '2024-11-10 13:58:10'),
(2, 1, 1, 3, 1, 'Pengembangan Aplikasi Mobile', '30000000', '2024-11-20', NULL, '2025-11-20', '2024', 'Selesai', 'Selesai', '2024-11-10 14:00:02', '2024-11-10 14:00:02');
...
--
ALTER TABLE `m_dosen`
  MODIFY `dosen_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `m_dosen_bidang`
--
ALTER TABLE `m_dosen_bidang`
  MODIFY `dosen_bidang_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `m_dosen_matkul`
--
ALTER TABLE `m_dosen_matkul`
  MODIFY `dosen_matkul_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `t_data_pelatihan`
  MODIFY `data_pelatihan_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `t_data_sertifikasi`
--
ALTER TABLE `t_data_sertifikasi`
  MODIFY `data_sertif_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `t_pelatihan`
--
ALTER TABLE `t_pelatihan`
  MODIFY `pelatihan_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `t_sertifikasi`
--
ALTER TABLE `t_sertifikasi`
  MODIFY `sertif_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
